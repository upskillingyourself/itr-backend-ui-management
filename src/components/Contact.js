        ...
        <>
            <section className='py-5' id='contact'>
                ...
                >
                    ...
                    <div className="contact__wrapper shadow-sm mt-n9" style={{marginTop:"50px"}}>
                        <div className="row no-gutters">
                            ...
                            <div className="col-lg-7 contact-form__wrapper p-5 order-lg-1">
                                <form onSubmit={handleSubmit(onSubmit)} className="contact-form form-validate" noValidate>
                                    <div className="row">
                                        <div className="col-sm-12 mb-3">
                                            <div className="form-group">
                                                <label className="form-label" htmlFor="firstName">Name</label>
                                                <input type="text" className="input" id="firstName" {...register("name", { required: true })} placeholder="Enter your Name" />
                                        ...
                                        <div className="col-sm-6 mb-3">
                                            <div className="form-group">
                                                ...
                                                <input type="email" className="input" id="email" {...register("email", { required: true })} placeholder="demo@gmail.com" />
                                        ...
                                        <div className="col-sm-12 mb-3">
                                            <div className="form-group">
                                                ...
                                                <textarea className="form-control" id="message" {...register("message")} rows="4" placeholder="Hi there, I would like to....."></textarea>
                                            </div>
                                        </div>
                                        <div className="col-sm-12 mb-3">
